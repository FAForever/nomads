...
Description = table.merged( Description, {
    ...
    ['xnl0001-se'] = "<LOC NomadsACUEnh_RapidRepair_Description>Increases health and adds a Emergency Repair device to the ACU, repairing the ACU automatically at no cost. There is a delay before repairs start, and the device must reinitialise each time the ACU is damaged or fires a weapon.",
    ['xnl0001-sepa'] = "<LOC NomadsACUEnh_PowerArmor_Description>Greatly increases the max health of the ACU and the efficiency of the Repair device.",
    ...
    ['xnl0301-se'] = "<LOC NomadsSCUEnh_RapidRepair_Description>Increases health and puts a Emergency Repair device on the SACU. It repairs the ACU automatically at no cost. There's a delay before the repairs start, the device needs to reinitialise each time the SACU is damaged or fires a weapon.",
    ['xnl0301-sepa'] = "<LOC NomadsSCUEnh_PowerArmor_Description>Greatly increases the max health of the SACU and the efficiency of the Repair device.",
    ...
    ['xnb2301'] = "<LOC xnb2301_help>Heavily armored defensive tower that attacks land- and sea-based units. Does not engage aircraft or submerged units.",

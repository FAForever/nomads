...
Description = table.merged( Description, {
    ...
    ['inu0301-il'] = "<LOC NomadSCUEnh_MovementSpeedIncrease_Description>This enhancement improves the locomotor on the Support Commander so that it can move faster.",
    ['inu0301-ses'] = "<LOC Unit_Description_0121>Speeds up all engineering-related functions.",
    ['inu0301-se'] = "<LOC NomadSCUEnh_RapidRepair_Description>Increases health and puts a rapid repair device on the SACU. It repairs the ACU automatically at no cost. There's a delay before the repairs start, the device needs to reinitialise each time the SACU is damaged or fires a weapon.",
    ['inu0301-sepa'] = "<LOC NomadSCUEnh_PowerArmor_Description>Upgrades the armor to powered armor, increasing the max health of the SACU.",
    ['inu0301-rag'] = "<LOC NomadSCUEnh_LeftArmGun_Description>Enhances the SACU with a kinetic cannon. When the capacitor ability is active the cannon gains a damage-over-time effect.",
    ['inu0301-rag2'] = "<LOC NomadSCUEnh_LeftArmGunUpgrade_Description>Upgrades the kinetic cannon so it deals more damage.",
    ['inu0301-acu'] = "<LOC NomadSCUEnh_RightArmGun_Description>Enhances the SACU with a rapid fire gattling gun. When the capacitor ability is active the gattling gun deals more damage.",
    ['inu0301-acu2'] = "<LOC NomadSCUEnh_RightArmGunUpgrade_Description>Upgrades the gattling cannon so it deals more damage.",
    ['inu0301-ses'] = "<LOC NomadSCUEnh_LeftArmEngineering_Description>Enhances the SACU with an additional engineering tool. Also allows the SACU to construct all Nomad structures. When the capacitor ability is active the engineering functions are sped up.",
    ['inu0301-rae'] = "<LOC NomadSCUEnh_RightArmEngineering_Description>Enhances the SACU with an additional engineering tool. Also allows the SACU to construct all Nomad structures. When the capacitor ability is active the engineering functions are sped up.",
    ['inu0301-acap'] = "<LOC NomadSCUEnh_AddCapacitor_Description>Enhances the SACU with an additional capacitor that increases the duration of the capacitor ability.",
    ['inu0301-lar'] = "<LOC NomadSCUEnh_LeftArmRocket_Description>Enhances the SACU with a rocket launcher attached to the left shoulder that fires salvos of rockets against surface targets. When the capacitor ability is active the rockets gain a damage-over-time effect.",
    ['inu0301-rar'] = "<LOC NomadSCUEnh_RightArmRocket_Description>Enhances the SACU with a rocket launcher attached to the right shoulder that fires salvos of rockets against surface targets. When the capacitor ability is active the rockets gain a damage-over-time effect.",
    ['inu0301-larg'] = "<LOC NomadSCUEnh_LeftArmRailgun_Description>Enhances the SACU with an under water railgun. When the capacitor ability is active the railgun deals more damage per shot.",
    ['inu0301-isb'] = "<LOC NomadSCUEnh_ResourceAllocation_Description>Adds a resource generator to the SACU. This system generates some resources, especially power, which speeds up the capacitor charge time. Because of the volatile nature of this generator, a large explosion is generated when the SACU dies. This enhancement is often used for increased firepower via capacitor but also sometimes for kamikaze attacks.",

...
Description = table.merged( Description, {
    ...
    ['xnl0001-isb'] = "<LOC Unit_Description_0012>Increases ACU's resource generation.",
    ...
    ['xnl0001-se'] = "<LOC NomadsACUEnh_RapidRepair_Description>Increases health and puts a rapid repair device on the ACU. It repairs the ACU automatically at no cost. The device needs to reinitialise each time the ACU is damaged.",
    ['xnl0001-sepa'] = "<LOC NomadsACUEnh_PowerArmor_Description>Upgrades the armor to powered armor, increasing the max health of the ACU.",
    ...
    ['xnl0301_Amphibious'] = "<LOC xnl0301_amphibious_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a railgun on the left arm, a machine gune on the right arm and an improved locomotor.",
    ['xnl0301_AntiNaval'] = "<LOC xnl0301_antinaval_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a railgun on the left arm, an additional capacitor on the right shoulder and an improved locomotor.",
    ['xnl0301_Combat'] = "<LOC xnl0301_combat_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with an upgraded main canon on the left arm and close combat machine gun on the right arm.",
    ['xnl0301_Default'] = "<LOC xnl0301_default_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with a weapon on its left arm and engineering capabilities on its right arm.",
    ['xnl0301_EnergyRocket'] = "<LOC xnl0301_energyrocket_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with a rocket launcher on both shoulders and a resource generator on the back to improve capacitor fill rate.",
    ['xnl0301_Engineer'] = "<LOC xnl0301_engineer_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with two engineering arms.",
    ['xnl0301_FastCombat'] = "<LOC xnl0301_fastcombat_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with a cannon, a machine gun and an improved locomotor.",
    ['xnl0301_Gunslinger'] = "<LOC xnl0301_gunslinger_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with an upgraded gun on its left arm and an additional capacitor for enhanced firepower.",
    ['xnl0301_Trooper'] = "<LOC xnl0301_trooper_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with a simple gun on its left arm.",
    ['xnl0301_HeavyTrooper'] = "<LOC xnl0301_heavytrooper_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with an upgraded gun on the left arm, a machine gun and a rapid repair system.",
    ['xnl0301_NaturalProducer'] = "<LOC xnl0301_naturalproducer_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with engineering capabilities on both arms and a resource generator on its back.",
    ['xnl0301_Rambo'] = "<LOC xnl0301_rambo_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with fully upgraded weapons, rapid repair and power armor.",
    ['xnl0301_Rocket'] = "<LOC xnl0301_rocket_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with a rocket launcher on both shoulders and improved locomotor.",
    ['xnl0301_Sniper'] = "<LOC xnl0301_sniper_help>Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or combination. Enhanced during construction with an upgraded weapon on its right arm and the sniper enhancement on its back.",

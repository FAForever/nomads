...
-- ACU
NomadACUEnh_DisruptiveField_Description = "Creates a disruptive field around the ACU that damages all enemy units within range."
NomadACUEnh_DisruptiveField_Help = "Disruptor field"
NomadACUEnh_DisruptiveField_Remove = "Remove disruptor field"

NomadACUEnh_OrbitalStrike_Description = "Adds a device that coordinates attacks from orbit on enemy units near the ACU."
NomadACUEnh_OrbitalStrike_Help = "Orbital strike"
NomadACUEnh_OrbitalStrike_Remove = "Remove orbital strike"

NomadACUEnh_OrbitalBombardment_Description = "Adds the ability to bombard a limited area from orbit. Only an area around the ACU and SCU's can be bombarded."
NomadACUEnh_OrbitalBombardment_Help = "Orbital bombardment"
NomadACUEnh_OrbitalBombardment_Remove = "Remove orbital bombardment"

NomadACUEnh_FlameThrower_Description = "Upgrades the main weapon to a flame thrower that damages all units in a line. Perfect against large groups of small to medium units."
NomadACUEnh_FlameThrower_Help = "Flame thrower"
NomadACUEnh_FlameThrower_Remove = "Remove flame thrower"

NomadACUEnh_AreaReinforcement_Description = "Allows deploying stationary reinforcements launched from orbit anywhere on the battlefield."
NomadACUEnh_AreaReinforcement_Help = "Orbital reinforcement"
NomadACUEnh_AreaReinforcement_Remove = "Remove Orbital reinforcement"

NomadACUEnh_AreaReinforcement2_Description = "Allows deploying stationary reinforcements launched from orbit anywhere on the battlefield."
NomadACUEnh_AreaReinforcement2_Help = "Orbital reinforcement"
NomadACUEnh_AreaReinforcement2_Remove = "Remove Orbital reinforcement"

NomadACUEnh_GunUpgrade_Description = "Increases main cannon's damage output by several factors. Also increases range of main cannon and overcharge."
NomadACUEnh_GunUpgrade_Help = "Gun upgrade"
NomadACUEnh_GunUpgrade_Remove = "Remove gun upgrade"

NomadACUEnh_DoubleGuns_Description = "All main gun damage (excluding overcharge) doubled by installing a second gun barrel next to the main gun."
NomadACUEnh_DoubleGuns_Help = "Double guns"
NomadACUEnh_DoubleGuns_Remove = "Remove double guns"

NomadACUEnh_RapidRepair_Description = "Increases health and puts a rapid repair device on the ACU. It repairs the ACU automatically at no cost. There's a delay before the repairs start, the device needs to reinitialise each time the ACU is damaged or fires a weapon."
NomadACUEnh_RapidRepair_Help = "Rapid repair"
NomadACUEnh_RapidRepair_Remove = "Remove rapid repair"

NomadACUEnh_PowerArmor_Description = "Upgrades the armor to powered armor, increasing the max health of the ACU."
NomadACUEnh_PowerArmor_Help = "Powered Armor"
NomadACUEnh_PowerArmor_Remove = "Remove Powered Armor"

NomadACUEnh_SniperMode_Description = "Allows the ACU to enable and disable sniper mode at will. Sniper mode increases the range and damage of the ACU's main weapon but disables overcharge. Stacks with the gun enhancements."
NomadACUEnh_SniperMode_Help = "Sniper Mode"
NomadACUEnh_SniperMode_Remove = "Remove Sniper Mode"

NomadACUEnh_IntelProbe_Description = "Intel probes provide temporary radar and sonar coverage at an area on the map."
NomadACUEnh_IntelProbe_Help = "Intel Probe"
NomadACUEnh_IntelProbe_Remove = "Remove Intel Probe"

NomadACUEnh_IntelProbeAdv_Description = "Upgrades the intel probe with enhanced sensors for better intelligence gathering."
NomadACUEnh_IntelProbeAdv_Help = "Advanced Intel Probe"
NomadACUEnh_IntelProbeAdv_Remove = "Remove Advanced Intel Probe"

NomadACUEnh_MovementSpeedIncrease_Description = "This enhancement improves the locomotor on the ACU so that it can move faster."
NomadACUEnh_MovementSpeedIncrease_Help = "Improved locomotor"
NomadACUEnh_MovementSpeedIncrease_Remove = "Remove improved locomotor"

NomadACUEnh_AddCapacitor_Description = "Enhances the ACU with an additional capacitor that increases the duration of the capacitor boost."
NomadACUEnh_AddCapacitor_Help = "Additional Capacitor"
NomadACUEnh_AddCapacitor_Remove = "Remove Additional Capacitor"

-- SCU
NomadSCUEnh_MovementSpeedIncrease_Description = "This enhancement improves the locomotor on the Support Commander so that it can move faster."
NomadSCUEnh_MovementSpeedIncrease_Help = "Improved Locomotor"
NomadSCUEnh_MovementSpeedIncrease_Remove = "Remove Improved Locomotor"

NomadSCUEnh_RapidRepair_Description = "Increases health and puts a rapid repair device on the SACU. It repairs the SACU automatically at no cost. There's a delay before the repairs start, the device needs to reinitialise each time the SACU is damaged or fires a weapon."
NomadSCUEnh_RapidRepair_Help = "Rapid Repair"
NomadSCUEnh_RapidRepair_Remove = "Remove rapid Repair"

NomadSCUEnh_PowerArmor_Description = "Upgrades the armor to powered armor, increasing the max health of the SACU."
NomadSCUEnh_PowerArmor_Help = "Powered Armor"
NomadSCUEnh_PowerArmor_Remove = "Remove Powered Armor"

NomadSCUEnh_LeftArmGun_Description = "Enhances the SACU with a kinetic cannon. When the capacitor ability is active the cannon gains a damage-over-time effect."
NomadSCUEnh_LeftArmGun_Help = "Left Arm Gun"
NomadSCUEnh_LeftArmGun_Remove = "Remove Left Arm Gun"

NomadSCUEnh_LeftArmGunUpgrade_Description = "Upgrades the kinetic cannon so it deals more damage."
NomadSCUEnh_LeftArmGunUpgrade_Help = "Upgrade Left Arm Gun"
NomadSCUEnh_LeftArmGunUpgrade_Remove = "Remove Upgraded Left Arm Gun"

NomadSCUEnh_RightArmGun_Description = "Enhances the SACU with a rapid fire gattling gun. When the capacitor ability is active the gattling gun deals more damage."
NomadSCUEnh_RightArmGun_Help = "Right Arm Gun"
NomadSCUEnh_RightArmGun_Remove = "Remove Right Arm Gun"

NomadSCUEnh_RightArmGunUpgrade_Description = "Upgrades the gattling gun so it deals more damage."
NomadSCUEnh_RightArmGunUpgrade_Help = "Upgrade Right Arm Gun"
NomadSCUEnh_RightArmGunUpgrade_Remove = "Remove Upgraded Right Arm Gun"

NomadSCUEnh_LeftArmEngineering_Description = "Enhances the SACU with an additional engineering tool. Also allows the SACU to construct all Nomad structures. When the capacitor ability is active the engineering functions are sped up."
NomadSCUEnh_LeftArmEngineering_Help = "Left Arm Engineering"
NomadSCUEnh_LeftArmEngineering_Remove = "Remove Left Arm Engineering"

NomadSCUEnh_RightArmEngineering_Description = "Enhances the SACU with an additional engineering tool. Also allows the SACU to construct all Nomad structures. When the capacitor ability is active the engineering functions are sped up."
NomadSCUEnh_RightArmEngineering_Help = "Right Arm Engineering"
NomadSCUEnh_RightArmEngineering_Remove = "Remove Right Arm Engineering"

NomadSCUEnh_AddCapacitor_Description = "Enhances the SACU with an additional capacitor that increases the duration of the capacitor ability."
NomadSCUEnh_AddCapacitor_Help = "Additional Capacitor"
NomadSCUEnh_AddCapacitor_Remove = "Remove Additional Capacitor"

NomadSCUEnh_LeftArmRocket_Description = "Enhances the SACU with a rocket launcher attached to the left shoulder that fires salvos of rockets against surface targets. When the capacitor ability is active the rockets gain wider splash damage and damage-over-time effect."
NomadSCUEnh_LeftArmRocket_Help = "Left Arm Rocket Launcher"
NomadSCUEnh_LeftArmRocket_Remove = "Remove Left Arm Rocket Launcher"

NomadSCUEnh_RightArmRocket_Description = "Enhances the SACU with a rocket launcher attached to the right shoulder that fires salvos of rockets against surface targets. When the capacitor ability is active the rockets gain wider splash damage and a damage-over-time effect."
NomadSCUEnh_RightArmRocket_Help = "Right Arm Rocket Launcher"
NomadSCUEnh_RightArmRocket_Remove = "Remove Right Arm Rocket Launcher"

NomadSCUEnh_LeftArmRailgun_Description = "Enhances the SACU with an under water railgun. When the capacitor ability is active the railgun's rate of fire is faster."
NomadSCUEnh_LeftArmRailgun_Help = "Left Arm Under Water Railgun"
NomadSCUEnh_LeftArmRailgun_Remove = "Remove Left Arm Under Water Railgun"

NomadSCUEnh_ResourceAllocation_Description = "Adds a resource generator to the SACU. This system generates some resources, especially power, which speeds up the capacitor charge time. Because of the volatile nature of this generator, a large explosion is generated when the SACU dies. This enhancement is often used for increased firepower via capacitor."
NomadSCUEnh_ResourceAllocation_Help = "Resource Generator"
NomadSCUEnh_ResourceAllocation_Remove = "Remove Resource Generator"
...
inu3001_desc = "Support Armored Command Unit"
inu3001_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. This variant is not enhanced during construction and does not have weapons and very limited engineering capabilities."
inu3001_name = "Support Armored Command Unit"

inu3001_combat_desc = "Support Armored Command Unit (Preset: Combat)"
inu3001_combat_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with an upgraded main cannon on the left arm and close combat machine gun on the right arm."
inu3001_combat_name = "Support Armored Command Unit (Preset: Combat)"

inu3001_default_desc = "Support Armored Command Unit (Preset: Regular)"
inu3001_default_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a weapon on the right arm and engineering capabilities on the left arm."
inu3001_default_name = "Support Armored Command Unit (Preset: Regular)"

inu3001_energyrocket_desc = "Support Armored Command Unit (Preset: Energy Rocket Launcher)"
inu3001_energyrocket_help= "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a rocket launcher on both shoulders and a resource generator on the back to improve capacitor fill rate."
inu3001_energyrocket_name = "Support Armored Command Unit (Preset: Energy Rocket Launcher)"

inu3001_engineer_desc = "Support Armored Command Unit (Preset: Engineer)"
inu3001_engineer_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with two engineering arms."
inu3001_engineer_name = "Support Armored Command Unit (Preset: Engineer)"

inu3001_fastcombat_desc = "Support Armored Command Unit (Preset: Fast Combat)"
inu3001_fastcombat_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a cannon, a machine gun and an improved locomotor."
inu3001_fastcombat_name = "Support Armored Command Unit (Preset: Fast Combat)"

inu3001_gunslinger_desc = "Support Armored Command Unit (Preset: Gunslinger)"
inu3001_gunslinger_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with an upgraded gun on the left arm and an additional capacitor on the right arm for enhanced firepower."
inu3001_gunslinger_name = "Support Armored Command Unit (Preset: Gunslinger)"

inu3001_heavytrooper_desc = "Support Armored Command Unit (Preset: Heavy Trooper)"
inu3001_heavytrooper_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with an upgraded gun on the left arm, a machine gun and a rapid repair system."
inu3001_heavytrooper_name = "Support Armored Command Unit (Preset: Heavy Trooper)"

inu3001_naturalproducer_desc = "Support Armored Command Unit (Preset: Producer)"
inu3001_naturalproducer_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with engineering capabilities on both arms and resource generator on its back."
inu3001_naturalproducer_name = "Support Armored Command Unit (Preset: Producer)"

inu3001_rambo_desc = "Support Armored Command Unit (Preset: Rambo)"
inu3001_rambo_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with fully upgraded weapons on both arms, rapid repair and power armor on the back."
inu3001_rambo_name = "Support Armored Command Unit (Preset: Rambo)"

inu3001_sniper_desc = "Support Armored Command Unit (Preset: Sniper)"
inu3001_sniper_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with an upgraded weapon on the right arm and the sniper enhancement on its back."
inu3001_sniper_name = "Support Armored Command Unit (Preset: Sniper)"

inu3001_rocket_desc = "Support Armored Command Unit (Preset: Rocket Launcher)"
inu3001_rocket_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a rocket launcher on both shoulders and improved locomotor."
inu3001_rocket_name = "Support Armored Command Unit (Preset: Rocket Launcher)"

inu3001_trooper_desc = "Support Armored Command Unit (Preset: Trooper)"
inu3001_trooper_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a simple gun on the left arm."
inu3001_trooper_name = "Support Armored Command Unit (Preset: Trooper)"

inu3001_antinaval_desc = "Support Armored Command Unit (Preset: Anti-Naval)"
inu3001_antinaval_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a railgun on the left arm, an additional capacitor on the right shoulder and an improved locomotor."
inu3001_antinaval_name = "Support Armored Command Unit (Preset: Anti-Naval)"

inu3001_amphibious_desc = "Support Armored Command Unit (Preset: Amphibious)"
inu3001_amphibious_help = "Houses a Nomads soldier. Can be Customised as a heavy combatant, improved T3 engineer or a combination. Enhanced during construction with a railgun on the left arm, a machine gun on the right arm and an improved locomotor."
inu3001_amphibious_name = "Support Armored Command Unit (Preset: Amphibious)"

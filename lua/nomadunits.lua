...
local CreateBuildCubeThread = NomadEffectUtil.CreateBuildCubeThread
local CreateNomadBuildSliceBeams = NomadEffectUtil.CreateNomadBuildSliceBeams
...
function AddNomadBeingBuiltEffects( SuperClass )
...
AirFactoryUnit = AddNomadBeingBuiltEffects(NomadSharedFactory(AirFactoryUnit))
NAirFactoryUnit = Class(AirFactoryUnit) {

}

SeaFactoryUnit = AddNomadBeingBuiltEffects(NomadSharedFactory(SeaFactoryUnit))

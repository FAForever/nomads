...
function AddFlares(SuperClass)
    ...
    return Class( SuperClass) {
        ...
        FlareBoneFx = NomadEffectTemplate.FlareMuzzleFx,
...
function SupportingArtilleryAbility(SuperClass)
    return Class(SuperClass) {
        ...
        PlaySupportedArtilleryTargetPosEffects = function(self, targetPos)
            ...
            local army, emit = self:GetArmy()
            for k, v in NomadEffectTemplate.ArtillerySupportAtTargetLocation do
    ...
    return Class(SuperClass) {
        ...
        GetLightTemplate = function(self, n)
            if self.BombardmentMode then
                return NomadEffectTemplate['AntennaeLights_'..tostring(n)..'_Bombard']
            end
            return NomadEffectTemplate['AntennaeLights'..tostring(n)]
        end,
...
function AddNavalLights(SuperClass)
    ...
    return Class(SuperClass) {
        ...
        GetLightTemplate = function(self, n)
            if self.BombardmentMode then
                if n == 0 then
                    return NomadEffectTemplate.NavalAntennaeLights_Left_Bombard
                end
                return NomadEffectTemplate.NavalAntennaeLights_Right_Bombard
            end
            if n == 0 then
                return NomadEffectTemplate.NavalAntennaeLights_Left
            end
            return NomadEffectTemplate.NavalAntennaeLights_Right
        end,
    }
end
...
function AddCapacitorAbility( SuperClass )
    ...
    return Class(SuperClass) {
        ...
        CapDoPlayFx = true,
        CapFxBones = nil,
        CapFxBeingUsedTemplate = NomadEffectTemplate.CapacitorBeingUsed,
        CapFxChargingTemplate = NomadEffectTemplate.CapacitorCharging,
        CapFxEmptyTemplate = NomadEffectTemplate.CapacitorEmpty,
        CapFxFullTemplate = NomadEffectTemplate.CapacitorFull,

local NomadCollisionBeamFile = import('/lua/nomadcollisionbeams.lua')
...
KineticCannon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.KineticCannonMuzzleFlash,
}
...
ArtilleryWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.ArtilleryMuzzleFx,
...
DarkMatterWeapon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.DarkMatterWeaponMuzzleFlash,
}
...
RailgunWeapon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.RailgunMuzzleFx,
}

UnderwaterRailgunWeapon1 = Class(RailgunWeapon1) {
    FxMuzzleFlash = NomadEffectTemplate.UnderWaterRailgunMuzzleFx,
}

StingrayCannon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.StingrayMuzzleFx,
}

ParticleBlaster1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.ParticleBlastMuzzleFlash,
}

PlasmaCannon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.PlasmaBoltMuzzleFlash,
}

AnnihilatorCannon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.AnnihilatorMuzzleFlash,
}

EnergyCannon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.EnergyProjMuzzleFlash,
...
RocketWeapon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.RocketMuzzleFx,
}
...
PhaseRayGun = Class(DefaultBeamWeapon) {
    BeamType = NomadCollisionBeamFile.NomadPhaseRay,
    FxChargeMuzzleFlash = NomadEffectTemplate.PhaseRayMuzzle,
}

FusionMissileWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.FusionMissileMuzzleFx,
}

EMPMissileWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.EMPMissileMuzzleFx,
}
...
DepthChargeBombWeapon1 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.DepthChargeBombMuzzleFx,
...
ConcussionBombWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = NomadEffectTemplate.ConcussionBombMuzzleFx,
